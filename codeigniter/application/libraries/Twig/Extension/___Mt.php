...
*/
class Twig_Extension_Mt extends \Twig_Extension {
    /**
    ...
    */
    public function getFilters( ) {
        return array(
            'evaluate' => new \Twig_Filter_Method( $this, 'mt', array(
     ...
     * @param string $string
     */
    public function mt( \Twig_Environment $environment, $context, $string ) {
