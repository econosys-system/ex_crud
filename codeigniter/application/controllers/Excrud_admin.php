...
// Version 1.02 change admin view dir
...
class Excrud_admin extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        // config
        $config_excrud = $this->config->item('excrud');
        if (@$config_excrud['excrud_admin_view_dir']) {
            $this->excrud_admin_view_dir = $config_excrud['excrud_admin_view_dir'] . '/';
        }
    ...
    public function index($table_name = '', $arg1 = '', $arg2 = '')
    {
        ...
        $output = $this->extwig->render($this->excrud_admin_view_dir . 'excrud_index.html', $data);
        print $output;
    }
    ...
    public function add($table_name)
    {
        ...
        $html = $this->extwig->render($this->excrud_admin_view_dir . 'excrud_edit.html', $data);
    ...
    public function delete($table_name, $data_id)
    {
        ...
        $output = $this->extwig->render($this->excrud_admin_view_dir . 'excrud_delete.html', $data);
        print $output;
    }
    ...
    public function dl_multiple_edit($table_name)
    {
        ...
        $html = $this->extwig->render($this->excrud_admin_view_dir . 'excrud_dl_multiple_edit.html', $data);
        print $html;
    ...
    public function sql($table_name)
    {
        ...
        $output = $this->extwig->render($this->excrud_admin_view_dir . 'excrud_sql.html', $data);
        print $output;
    }
    ...
    public function json_sample_create()
    {
        ...
        if ($back_url) {redirect($back_url);} else {redirect("/excrud_admin/");}
    }
